...
/***/ function(module, exports, __webpack_require__) {
	...
	var _universalFetch = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProjectForm = __webpack_require__(199);

	var _ProjectForm2 = _interopRequireDefault(_ProjectForm);

	var _FetchError = __webpack_require__(198);
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			...
			value: function componentWillMount() {
				this.props.dispatch((0, _actions.getBaseRequest)());
			}
		}, {
			key: 'render',
			value: function render() {
				var mybody = this.props.error ? _react2.default.createElement(_FetchError2.default, { error: this.props.error }) : _react2.default.createElement(_Loading2.default, null);
				var links = this.props.GetAllProjsUrl;

				if (links != null) {
					mybody = _react2.default.createElement(_ProjectList2.default, { base_url: links });
				}
	...
	function connectApp(state) {
		return { GetAllProjsUrl: state.homeState.GetAllProjectsLink,
			error: state.errorState.error };
	}

	exports.default = (0, _reactRedux.connect)(connectApp)(App);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProjectIssues = __webpack_require__(196);
	...
	var ProjectList = function (_Component) {
	  ...
	  _createClass(ProjectList, [{
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      this.props.dispatch((0, _actions.getAllProjects)(this.props.base_url));
	    }
	  }, {
	    key: 'filterProjects',
	    value: function filterProjects(filter) {
	      this.props.dispatch((0, _actions.getAllProjectsFiltered)(this.props.base_url, filter));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var filterProj = void 0;

	      var body = this.props.error ? _react2.default.createElement(_FetchError2.default, { error: this.props.error }) : this.props.projects == null ? _react2.default.createElement(_Loading2.default, null) : _react2.default.createElement(
	        'ul',
	        null,
	        this.props.projects.map(function (proj) {
	          return _react2.default.createElement(
	            'li',
	            { key: proj.Properties.name },
	            _react2.default.createElement(
	              'a',
	              { href: '#', onClick: function onClick(ev) {
	                  _this2.props.dispatch((0, _actions.getProject)(proj.Properties.name));
	                } },
	              proj.Properties.name
	            ),
	            _react2.default.createElement(_ProjectIssues2.default, { project_url: proj.Links[0].Href })
	          );
	        })
	      );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(_ProjectForm2.default, { postUrl: this.props.postUrl })
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement('input', { ref: function ref(node) {
	              return filterProj = node;
	            } }),
	          _react2.default.createElement(
	            'button',
	            { onClick: function onClick() {
	                return _this2.filterProjects(filterProj.value);
	              } },
	            'Filtrar'
	          )
	        ),
	...
	function connectList(state) {
	  return { projects: state.projectState.projects,
	    postUrl: state.projectState.postUrl,
	    error: state.errorState.error };
	}

	exports.default = (0, _reactRedux.connect)(connectList)(ProjectList);
	//
	/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.URL_ISSUES = exports.URL_PROJECT = exports.URL_PROJECTS = exports.ENDPOINT_URL = exports.BASE_URL = exports.OPERATION_FAILED = exports.POST_ISSUE_REMOVE = exports.POST_ISSUE_ADD = exports.GET_ISSUE_TAGS = exports.POST_ISSUE_COMMENT = exports.GET_ISSUE_COMMENTS = exports.POST_TAG = exports.POST_FILTERED_ISSUES = exports.POST_ISSUE = exports.GET_FILTERED_PROJECTS = exports.POST_PROJECT = exports.GET_ISSUE = exports.HOME = exports.GET_PROJECT_ISSUES = exports.GET_PROJECT = exports.GET_ALL_PROJECTS = undefined;

	var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; };

	exports.onHomeLoaded = onHomeLoaded;
	exports.onAllProjectsLoaded = onAllProjectsLoaded;
	exports.onProjectCreated = onProjectCreated;
	exports.onProjectsFiltered = onProjectsFiltered;
	exports.onProjectLoaded = onProjectLoaded;
	exports.onIssueCreated = onIssueCreated;
	exports.onIssuesFiltered = onIssuesFiltered;
	exports.onTagCreated = onTagCreated;
	exports.onProjectIssuesLoaded = onProjectIssuesLoaded;
	exports.onIssueLoaded = onIssueLoaded;
	exports.onCommentsLoaded = onCommentsLoaded;
	exports.onCommentCreated = onCommentCreated;
	exports.onIssueTagsLoaded = onIssueTagsLoaded;
	exports.onIssueTagAdded = onIssueTagAdded;
	exports.onIssueTagsRemoved = onIssueTagsRemoved;
	exports.onError = onError;
	exports.baseRequest = baseRequest;
	exports.getBaseRequest = getBaseRequest;
	exports.getAllProjects = getAllProjects;
	exports.getAllProjectsFiltered = getAllProjectsFiltered;
	exports.postAddProject = postAddProject;
	exports.getIssueDetail = getIssueDetail;
	...
	var GET_ALL_PROJECTS = exports.GET_ALL_PROJECTS = 'GET_ALL_PROJECTS';
	var GET_PROJECT = exports.GET_PROJECT = 'GET_PROJECT';
	var GET_PROJECT_ISSUES = exports.GET_PROJECT_ISSUES = 'GET_PROJECT_ISSUES';
	var HOME = exports.HOME = 'HOME';
	var GET_ISSUE = exports.GET_ISSUE = 'GET_ISSUE';
	var POST_PROJECT = exports.POST_PROJECT = 'POST_PROJECT';
	var GET_FILTERED_PROJECTS = exports.GET_FILTERED_PROJECTS = 'GET_FILTERED_PROJECTS';
	var POST_ISSUE = exports.POST_ISSUE = 'POST_ISSUE';
	var POST_FILTERED_ISSUES = exports.POST_FILTERED_ISSUES = 'POST_FILTERED_ISSUES';
	var POST_TAG = exports.POST_TAG = 'POST_TAG';
	var GET_ISSUE_COMMENTS = exports.GET_ISSUE_COMMENTS = 'GET_ISSUE_COMMENTS';
	var POST_ISSUE_COMMENT = exports.POST_ISSUE_COMMENT = 'POST_ISSUE_COMMENT';
	var GET_ISSUE_TAGS = exports.GET_ISSUE_TAGS = 'GET_ISSUE_TAGS';
	var POST_ISSUE_ADD = exports.POST_ISSUE_ADD = 'POST_ISSUE_ADD';
	var POST_ISSUE_REMOVE = exports.POST_ISSUE_REMOVE = 'POST_ISSUE_REMOVE';
	var OPERATION_FAILED = exports.OPERATION_FAILED = 'OPERATION_FAILED';

	var BASE_URL = exports.BASE_URL = 'http://issuemanager.azurewebsites.net/api';
	var ENDPOINT_URL = exports.ENDPOINT_URL = 'http://issuemanager.azurewebsites.net';
	var URL_PROJECTS = exports.URL_PROJECTS = "/projects";
	var URL_PROJECT = exports.URL_PROJECT = "/project";
	var URL_ISSUES = exports.URL_ISSUES = "/issues";
	// on actions completed

	// ==== Screen 1 - Home Screen ====
	function onHomeLoaded(items) {
	  return { type: HOME, items: items };
	}

	function onAllProjectsLoaded(response) {
	  return { type: GET_ALL_PROJECTS, response: response };
	}
	...
	function onProjectsFiltered(projects, filter) {
	  return { type: GET_FILTERED_PROJECTS, projects: projects, filter: filter };
	}

	// ==== Screen 2 - Project Detail Screen ====
	function onProjectLoaded(project) {
	  return { type: GET_PROJECT, project: project };
	}

	function onIssueCreated(issue) {
	  return { type: POST_ISSUE, issue: issue };
	}

	function onIssuesFiltered(filteredIssues) {
	  return { type: POST_FILTERED_ISSUES, filteredIssues: filteredIssues };
	}

	function onTagCreated(tag) {
	  return { type: POST_TAG, tag: tag };
	}

	function onProjectIssuesLoaded(issues) {
	  return { type: GET_PROJECT_ISSUES, issues: issues };
	}

	// ==== Screen 3 - Issue Detail screen ====

	function onIssueLoaded(issue) {
	  return { type: GET_ISSUE, issue: issue };
	}

	function onCommentsLoaded(comments) {
	  return { type: GET_ISSUE_COMMENTS, comments: comments };
	}

	function onCommentCreated(comment) {
	  return { type: POST_ISSUE_COMMENT, comment: comment };
	}

	function onIssueTagsLoaded(tags) {
	  return { type: GET_ISSUE_TAGS, tags: tags };
	}

	function onIssueTagAdded(tag) {
	  return { type: POST_ISSUE_ADD, tag: tag };
	}

	function onIssueTagsRemoved(tag) {
	  return { type: POST_ISSUE_REMOVE, tag: tag };
	}

	// errors

	function onError(error) {
	  return { type: OPERATION_FAILED, error: error };
	}

	// do actions

	function baseRequest(url, invokeAction) {

	  return function (dispatch) {
	    return (0, _universalFetch2.default)(url).then(function (resp) {
	      if (resp.status !== 200) {
	...
	function getBaseRequest() {
	  return baseRequest(BASE_URL, onHomeLoaded);
	}

	function getAllProjects(url) {
	  return baseRequest(url, onAllProjectsLoaded);
	}

	function getAllProjectsFiltered(url, filter) {
	  return function (dispatch) {
	    return (0, _universalFetch2.default)(url).then(function (resp) {
	      if (resp.status !== 200) {
	        throw new Error(resp.status);
	      ...
	      dispatch(onProjectsFiltered(body, filter));
	      return body;
	    }).catch(function (error) {
	      dispatch(onError(error.message));
	    });
	...
	function postAddProject(url, projectName, projectOwner) {

	  var decycle = __webpack_require__(195).decycle;
	  ...
	  return function (dispatch) {
	    ...
	    var request = {
	      ...
	      body: JSON.stringify(postBody, decycle())
	    };
	    console.log(JSON.stringify(postBody, decycle()));

	    return (0, _universalFetch2.default)(url, request).then(function (resp) {
	      ...
	      dispatch(onProjectCreated(body));
	      return body;
	    }).catch(function (error) {
	      dispatch(onError(error.message));
	    });
	...
	function getIssueDetail(projectName, issueId) {
	  var url = BASE_URL + URL_PROJECTS + "/" + projectName + URL_ISSUES + "/" + issueId;
	  var func = onIssueLoaded;

	  return baseRequest(url, func);
	}
	...
	export function getAllProjects() {
	    ...
	    return dispatch => {
	      return fetch(BASE_URL+URL_PROJECTS)
	      .then(resp => {
	        if(resp.status !== 200){
	          throw new Error(resp.status)
	        }else{
	...
	function getProjectIssues(url) {
	  return function (dispatch) {
	    return (0, _universalFetch2.default)(url).then(function (resp) {
	      ...
	      console.log(body);
	      var issuesUrl = body.Entities[0].Links[0].Href;
	      console.log(issuesUrl);
	      return (0, _universalFetch2.default)(issuesUrl);
	    }).then(function (resp) {
	      if (resp.status !== 200) {
	        throw new Error(resp.status);
	      } else {
	      ...
	      dispatch(onProjectIssuesLoaded(body));
	      return body;
	    }).catch(function (error) {
	      dispatch(onError(error.message));
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectIssues = function (_Component) {
	  _inherits(ProjectIssues, _Component);

	  function ProjectIssues() {
	    _classCallCheck(this, ProjectIssues);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ProjectIssues).apply(this, arguments));
	  }

	  _createClass(ProjectIssues, [{
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      // mudar para dispatch accao
	      this.props.dispatch((0, _actions.getProject)(this.props.project_url));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      console.log(this.props.proj);
	      var body = this.props.proj == null ? _react2.default.createElement(_Loading2.default, null) : _react2.default.createElement(
	        'ul',
	        null,
	        this.props.proj.Entities[0].Entities.map(function (issue) {
	          return _react2.default.createElement(
	            'li',
	            { key: issue.Properties.id },
	...
	function connectIssues(state) {
	  return { proj: state.projectState.project };
	}

	exports.default = (0, _reactRedux.connect)(connectIssues)(ProjectIssues);

	/*

	            <a href="#" onClick={ev=>{this.props.dispatch(getIssueDetail(issue.Project.Name,issue.Id))}}>
	*/
...
/***/ function(module, exports, __webpack_require__) {
	...
	function connectLoading(state) {
	    return {};
	}

	exports.default = (0, _reactRedux.connect)(connectLoading)(Loading);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FetchError = function (_Component) {
	    _inherits(FetchError, _Component);

	    function FetchError() {
	        _classCallCheck(this, FetchError);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FetchError).apply(this, arguments));
	    }
	...
	function connectError(state) {
	    return { error: state.errorState.error };
	}

	exports.default = (0, _reactRedux.connect)(connectError)(FetchError);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectForm = function (_Component) {
	    ...
	    function ProjectForm() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ProjectForm).apply(this, arguments));
	    }
	    ...
	    _createClass(ProjectForm, [{
	        ...
	        key: 'createProject',
	        value: function createProject(name, owner) {
	            this.props.dispatch((0, _actions.postAddProject)(this.props.url, name, owner));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('br', null),
	                _react2.default.createElement('input', { ref: function ref(node) {
	                        return inputOwner = node;
	                    } }),
	                _react2.default.createElement('br', null),
	                _react2.default.createElement(
	                    'button',
	                    { onClick: function onClick() {
	                            return _this2.createProject(inputName.value, inputOwner.value);
	                        } },
	                    'Criar'
	                )
	            );
	...
	function connectForm(state) {
	    return { url: state.projectState.postUrl };
	}

	exports.default = (0, _reactRedux.connect)(connectForm)(ProjectForm);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function projectReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { postUrl: 'undefined', projects: [], issues: [], proj: 'undefined' } : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case _actions.GET_ALL_PROJECTS:
	      return state = update(state, { projects: action.response.Entities,
	        postUrl: action.response.Actions.filter(function (item) {
	          return item.Method == "Put";
	        })[0].Href });
	    case _actions.GET_PROJECT:
	      console.log(action.project);
	      return state = update(state, { proj: action.project });
	    case _actions.POST_PROJECT:
	      var projs = state.projects;
	      projs.push(action.project.Entities[0]);
	      return Object.assign({}, state, { projects: projs });
	    case _actions.GET_PROJECT_ISSUES:
	      return state = update(state, { issues: action.issues });
	    case _actions.GET_FILTERED_PROJECTS:
	      return state = update(state, { projects: filterProjects(action.projects.Entities, action.filter) });
	    default:
	      return state;
	  }
	}
	...
	function homeReducer() {
	  ...
	  switch (action.type) {
	    case _actions.HOME:
	      var LinkGetAllProj = findLink(action.items.Links, ['project', 'collection']);
	      var LinkGetAllIssues = findLink(action.items.Links, ['issue', 'collection']);
	      return Object.assign({}, state, {
	        GetAllProjectsLink: LinkGetAllProj,
	        GetAllIssuesLink: LinkGetAllIssues
	      });
	    default:
	      return state;
	  }
	...
	function errorsReducer() {
	  ...
	  switch (action.type) {
	    case _actions.OPERATION_FAILED:
	...
	// Aqui vamos adicionar todos os reducers.
	var gitApp = (0, _redux.combineReducers)({
	...
	exports.default = gitApp;

	/******************* 
	  HELPER METHODS
	********************/

	function findLink(links, searchArray) {

	  for (var i = 0; i < links.length; i++) {
	    if (links[i].Rel.length == searchArray.length) {
	      var found = true;
	      for (var j = 0; j < searchArray.length; j++) {
	        if (links[i].Rel[j] != searchArray[j]) {
	          found = false;
	          break;
	        }
	      }
	      if (found) return links[i].Href;
	    }
	  }
	}
	...
	function filterProjects(projects, filter) {
	  ...
	  if (filter != null && filter != "") {
	    for (var i = 0; i < projects.length; i++) {
	      if (projects[i].Properties.name.indexOf(filter) > -1) filteredProjs.push(projects[i]);
	    }
	  } else {
